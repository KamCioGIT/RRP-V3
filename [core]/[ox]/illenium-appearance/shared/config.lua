...
Config.Stores = {
    ...
    {
        type = "surgeon",
        coords = vector4(303.54, -592.17, 43.27, 68.93),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = false,
        points = {
        ...
        ["Male"] = {
            {
                name = "PCSO",
                outfitData = {
                    ["pants"] = {item = 215, texture = 0}, -- Pants
                    ["t-shirt"] = {item = 217, texture = 0}, -- T Shirt
                    ["vest"] = {item = 93, texture = 0}, -- Body Vest
                    ["torso2"] = {item = 574, texture = 0}, -- Jacket
