...
Config.MinimumPAleto2 = 4
Config.MinimumPacificPolice = 5
Config.MinimumlowerVaultPolice = 5 -- This also includes thermite in the lower Vault
...
Config.PaletoGoldChance = 50 -- What percent chance of getting a gold table in a Paleto?
Config.PacificGoldChance = 50 -- What percent chance of getting a gold table in a Pacific?
...
Config.MarkedBillsWorthMin = 150 -- Minimum worth of a bag
Config.MarkedBillsWorthMax = 200 -- Maximum worth of a bag
-- NOTES --
...
---- ** FLEECA ** ----
Config.FleecaBagsMin = 50 -- How many bags of Marked Bills can you MINIMUM get from a FLeeca Table?
Config.FleecaBagsMax = 100 -- How many bags of Marked Bills can you MAXIMUM get from a FLeeca Table?
Config.FleecaGoldMin = 1 -- Minimum gold bars from Fleecas
Config.FleecaGoldMax = 2 -- Maximum gold bars from Fleecas

---- ** PALETO ** ----
Config.PaletoBagsMin = 75 -- How many bags of Marked Bills can you MINIMUM get from a Paleto Table?
Config.PaletoBagsMax = 150 -- How many bags of Marked Bills can you MAXIMUM get from a Paleto Table?
Config.PaletoGoldMin = 1 -- Minimum gold bars from Paleto
Config.PaletoGoldMax = 2 -- Maximum gold bars from Paleto

---- ** PALETO SECOND ** ----
Config.PaletoSecondMinBags = 1 -- How many bags of Marked Bills can you MINIMUM get from a Paleto Second Table
Config.PaletoSecondMaxBags = 2 -- How many bags of Marked Bills can you MAXIMUM get from a Paleto Second Table?
Config.PaletoSecondGoldMin = 1 -- Minimum gold bars from Paleto Second
Config.PaletoSecondGoldMax = 2 -- Maximum gold bars from Paleto Second

---- ** PACIFIC LOOT TABLES ** ----
Config.PacificBagsMin = 150 -- How many bags of Marked Bills can you MINIMUM get from a pacific Table?
Config.PacificBagsMax = 200 -- How many bags of Marked Bills can you MAXIMUM get from a pacific Table?
Config.PacificGoldMin = 1 -- Minimum gold bars from pacific
Config.PacificGoldMax = 2 -- Maximum gold bars from pacific

---- ** LOWER VAULT LOOT TABLES ** ----
Config.LowerVaultBagsMin = 1 -- How many bags of Marked Bills can you MINIMUM get from a lowervault Table?
Config.LowerVaultBagsMax = 2 -- How many bags of Marked Bills can you MAXIMUM get from a lowervault Table?
Config.LowerVaultGoldMin = 1 -- Minimum gold bars from Lower Vault
Config.LowerVaultGoldMax = 2 -- Maximum gold bars from Lower Vault
Config.LowerVaultDiamondMin = 1 -- Minimum amount of Diamonds from a lowervault
Config.LowerVaultDiamondMax = 2 -- Maximum amount of Diamonds from a lowervault
...
Config.Lockers = {
    ["Fleeca"] = {
        ...
        ["ItemAmount"] = math.random(2,4), -- Put minimum and Maximum amount of items inside the randomiser
        ---- RARE ITEMS ----
        ...
        ["RareAmount"] = math.random(1,2), -- Put minimum and Maximum amount of items inside the randomiser
        ---- CASH ITEMS ----

        ["Cash"] = 'markedbills',
        ["CashAmount"] = math.random(10,30), -- Put minimum and Maximum amount of items inside the randomiser
    },
    ["Paleto"] = {
        ---- NORMAL ITEMS ----
        ["items"] = {
        ...
        ["ItemAmount"] = math.random(1,2), -- Put minimum and Maximum amount of items inside the randomiser
        ---- RARE ITEMS ----
        ["Chance"] = 10, -- CHANCE OF GETTING RARE OR CASH ITEM
        ...
        ["Cash"] = 'markedbills',
        ["CashAmount"] = math.random(10,40), -- Put minimum and Maximum amount of items inside the randomiser
    },
    ["PaletoVault"] = { -- This is Paleto SECOND vault
        ...
        ["Cash"] = 'markedbills',
        ["CashAmount"] = math.random(15,50), -- Put minimum and Maximum amount of items inside the randomiser
    },
    ["Pacific"] = {
        ---- NORMAL ITEMS ----
        ["items"] = {
