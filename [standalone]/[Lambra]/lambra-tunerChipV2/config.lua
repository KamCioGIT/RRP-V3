...
Config.PopsCommand = "pops" --the command name to toggle ON/OFF if the vehicle have pops_bangs enabled
...
Config.Chips = {--You can add more chips and customize to your likings
    ...
    --jobWhitelist = the jobs required to install the chip (leave empty like this { } so everyone can apply) (you can set multiple jobs for the same chip)
    ...
    --[flames]
        ...
        --color = RGB color of the flames, make sure to set a predominant color ( set false to disable the coloring) (values go from 0.0 to 1.0 according to fivem natives, but sometimes higher values than that make the difference)
