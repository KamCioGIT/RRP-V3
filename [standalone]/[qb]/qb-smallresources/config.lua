...
Config.Consumables = {
    eat = { -- default food items
        ['eggsandwich'] = math.random(35, 54),
        ['hamsandwich'] = math.random(35, 54),
        ['tunasandwich'] = math.random(35, 54),
        ['psnqs'] = math.random(35, 54),
        ['meteorite'] = math.random(35, 54),
    ...
    drink = { -- default drink items
        ...
        ['dirtywater'] = math.random(15, 24),
        ['ecola'] = math.random(35, 54),
        ['sprunk'] = math.random(35, 54),
        ['orangotang'] = math.random(35, 54),
