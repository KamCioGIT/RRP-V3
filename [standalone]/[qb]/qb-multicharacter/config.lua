...
Config.DefaultSpawn = vector3(-268.54, -956.67, 31.22) -- Default spawn coords if you have start apartments disabled
...
Config.PlayersNumberOfCharacters = { -- Define maximum amount of player characters by rockstar license (you can find this license in your server's database in the player table)
    { license = "discord:871902966540542002", numberOfChars = 5 },
	{ license = "discord:802961683039518760", numberOfChars = 5 },
}