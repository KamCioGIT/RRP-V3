return {
    ...
    { label = "a_m_y_runner_01", value = "male"},
    { label = "AdvWarfareMarine", value = "male"},
    { label = "BlackPanther", value = "male"},
    { label = "Butthead", value = "male"},
    { label = "Calamardo", value = "male"},
    { label = "CrossBones", value = "male"},
    { label = "DarthVader", value = "male"},
    { label = "Deadpool", value = "male"},
    { label = "FreddyKrueger", value = "male"},
    { label = "Ghillie", value = "male"},
    { label = "Goku", value = "male"},
    { label = "hansolo", value = "male"},
    { label = "homer", value = "male"},
    { label = "Jason", value = "male"},
    { label = "kermit", value = "male"},
    { label = "KyloRen", value = "male"},
    { label = "Leatherface", value = "male"},
    { label = "LisaNude", value = "male"},
    { label = "MMyers", value = "male"},
    { label = "Nc_Pepe", value = "male"},
    { label = "patrick", value = "male"},
    { label = "RobocopV2", value = "male"},
    { label = "s_m_y_swat_01", value = "male"},
    { label = "shrek", value = "male"},
    { label = "skeleton", value = "male"},
    { label = "SlenderMan", value = "male"},
    { label = "Sonic", value = "male"},
    { label = "StormTrooper", value = "male"},
    { label = "STR_OptimusPrimeBIG", value = "male"},
    { label = "t600", value = "male"},
    { label = "thanos_gotg", value = "male"},
    { label = "ThePredator", value = "male"},
    { label = "Thor_IW", value = "male"},
    { label = "WarMachinemk3", value = "male"},
    { label = "wick2", value = "male"},
    { label = "WMmk2", value = "male"},
    { label = "yondu", value = "male"}
}