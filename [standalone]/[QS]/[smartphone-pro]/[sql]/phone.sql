...
CREATE TABLE `phone_notes` (
    ...
    `baslik` TEXT NOT NULL COLLATE 'utf8mb4_general_ci',
    `aciklama` TEXT NOT NULL COLLATE 'utf8mb4_general_ci',
    PRIMARY KEY (`id`) USING BTREE
) COLLATE = 'utf8mb4_general_ci' ENGINE = InnoDB AUTO_INCREMENT = 8;
