...
Config.DealershipLocations = {
  ["pdm"] = {
    ...
    categories = {"Albany", "Annis", "Benefactor", "BF", "Brute", "Bravado", "Coil", "Canis", "Cheval", "Declasse", "Dundreary", "Dewbauchee", "Dinka", "Enus", "Emperor", "Maxwell", "Pfister", "Overflod", "Gallivanter", "Imponte", "Invetero", "Grotti", "Hijak", "Karin", "Lampadati", "LCC", "Maibatsu", "Nagasaki", "Ocelot", "Obey", "Ubermacht", "Pegassi", "Principe", "Rune", "Shitzu", "Truffade", "Vulcar", "Vapid", "Weeny", "Progen", "Willard", "WMC", "Zirconium"},
